...
const translations = {
  zh: {
    ...
    "page.description": "10 个 AI 开发 skill,加上短版 always-on 规则、baseline rationale 和 team policy guide,串起设计上下文、需求对齐、实施方案、TDD、Bug 修复、验证、代码评审和分支收尾。",
    ...
    "hero.text": "dev-skills 为 Claude Code 与 Codex 提供 10 个工程流程 skill 和精简 always-on 团队规则,让设计上下文、需求、实现、验证、评审与收尾都有清晰边界和可复核结果。",
    ...
    "skills.title": "10 个 skill,每个只做一件事。",
    "skills.text": "把它当成开发导航:不确定下一步就问 dev-auto。做 UI 或 landing page 前先用 dev-design-context 沉淀设计上下文;做新功能从 dev-spec 开始,再到 plan、TDD、verify、review、finish;修 bug 从 dev-fix 开始。",
    "skills.list.aria": "dev-skills 列表",
    "skill.auto.kicker": "入口推荐",
    "skill.auto.desc": "不知道下一步该跑哪个时,扫描 artifacts 并推荐下一条命令。",
    "skill.designContext.kicker": "设计上下文",
    ...
    "skill.artifact.designContext": "Artifact: .design-context.md",
  ...
  en: {
    ...
    "page.description": "Ten AI development workflow skills plus concise always-on rules, baseline rationale, and a team policy guide for design context, specs, planning, TDD, bug fixes, verification, review, and branch closure.",
    ...
    "hero.text": "dev-skills gives Claude Code and Codex ten engineering workflow skills plus concise always-on team rules, so design context, requirements, implementation, verification, review, and closure each have clear boundaries and checkable evidence.",
    ...
    "skills.eyebrow": "Skill library",
    "skills.title": "Ten skills, one job each.",
    "skills.text": "Treat it as development navigation: ask dev-auto when the next step is unclear. Run dev-design-context before UI or landing-page work to capture design context. New features start with dev-spec, then move through plan, TDD, verify, review, and finish. Bugs start with dev-fix.",
    ...
    "skill.designContext.kicker": "Design context",
...
const localizedTargets = [
  ...
  { selector: ".skill-card:nth-child(10) small", key: "skill.artifact.none" },
